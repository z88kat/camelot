...
![In-game screenshot: exploring a dungeon](images/dungeon.png)
...
_Weather adds extra time: Rain +2, Storm +5, Snow +4, Fog +1, Wind +1 min per step._
...
**Item level gating:** many items now require a minimum player level to equip or use. If you try to use one too early, the inventory refuses: _"You need to be level X to use this item."_ Most consumables (potions, food, scrolls) are **not** gated.
...
Any food you eat has a **5% chance** of being bad and giving you **food poisoning** -- even fresh bread or cooked meat can occasionally turn your stomach. While poisoned you lose **1 HP per turn for 8-25 turns**. It will not kill you (damage clamps at 1 HP), and when it wears off you see _"The sickness passes."_
